...
export default function Curriculum() {
  ...
  return (
    <div className="w-full flex flex-row items-center justify-center h-full p-3 flex-wrap download-container">
      ...
      <div className="flex flex-row items-center justify-between mx-5">
        ...
        <button
          className="download-buton flex flex-row justify-evenly items-center text-white w-36 mx-2 h-8 rounded-lg hover:scale-105 hover:shadow-lg"
          onClick={saveFile}
        >
          download
