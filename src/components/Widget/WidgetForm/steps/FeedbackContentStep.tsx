      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="p-2 bg-purple-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm text-white hover:bg-purple-400 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-zinc-900 focus:ring-purple-500 transition-colors disabled:opacity-50 disabled:hover:bg-purple-500"
          >
            Enviar
          </button>
        </footer>
